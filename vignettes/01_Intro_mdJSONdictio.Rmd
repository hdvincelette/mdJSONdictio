...
Compares a tabular data dictionary to a dataset and summarizes discrepancies in a data frame. The input data dictionary must be formatted to a template as described in the [Tabular Data Dictionary Template article](https://hdvincelette.github.io/mdJSONdictio/articles/02_Dictionary_Template.html).
<br />
<br />
