...
Transforms a tabular data dictionary into an R list that can be subsequently converted to mdJSON and imported to mdEditor as a Dictionary record. The input data frame must be formatted to the template as described in the Tabular Data Dictionary Template section below.
<br />
<br />
...
include_graphics(system.file("help/figures","dictionary_template.png", package = "mdJSONdictio"))
```
</font>
<br />
<br />
