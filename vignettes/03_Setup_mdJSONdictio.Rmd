...
mdJSONdictio requires other packages to work properly. R will automatically install any dependent packages not currently in your library. If may prompt you to update these dependent packages during installation. To update all, type "1" in the Console pane and hit Enter. If a pop-up asks “Do you want to install from sources the packages which need compilation?”, click Yes.
