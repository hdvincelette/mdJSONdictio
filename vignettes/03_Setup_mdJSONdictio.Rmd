...
```
Note, "wininet" is a Windows only download method. If using a different operating system, refer to https://www.rdocumentation.org/packages/utils/versions/3.6.2/topics/download.file to view alternative methods.
<br />
<br />
**Rerun the [mdJSONdictio installation code](https://hdvincelette.github.io/mdJSONdictio/articles/03_Setup_mdJSONdictio.html#run-installation-code-in-rstudio).**
<br />
