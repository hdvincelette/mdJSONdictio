...
<br />
<br />
If package updates fail, installation of mdJSONdictio may halt. In this case, the following warning message may appear: 'installation of package...had non-zero exit status'.

See [Troubleshooting Tips](https://hdvincelette.github.io/mdJSONdictio/articles/03_Setup_mdJSONdictio.html#failed-dependent-package-update) for an alternative way to update dependent packages.
<br />
