...
### Open FWS-Apps-to-Go in Windows

##### Searching "FWS-Apps-to-Go" in the Windows search box
![](https://github.com/hdvincelette/mdJSONdictio/raw/master/man/figures/FWS_Apps_Search.png){width=50%}
<br />
<br />

### Locate R and RStudio in FWS-Apps-to-Go
...
##### Searching “IFW-R” in the Applications search box
...
##### Searching "RStudio" in the Windows search box
...
##### Package update prompt in RStudio
![](https://github.com/hdvincelette/mdJSONdictio/raw/master/man/figures/RStudio_Package_Update.png)
<br />
If package updates fail, installation of mdJSONdictio may halt. See [Troubleshooting Tips](https://hdvincelette.github.io/mdJSONdictio/articles/03_Setup_mdJSONdictio.html#if-dependent-package-updates-fail) for an alternative way to update dependent packages.
...
## Failed mdJSONdictio installation
...
## Failed dependent package update
