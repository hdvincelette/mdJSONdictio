...
<font size="2.5"> 
```{r, echo=FALSE}
kable(read.csv(path<-system.file("extdata", "datatype.rules.csv", package = "mdJSONdictio"),  fileEncoding="latin1", na.strings = NA), align = "l") %>%
